...
class PATJAITeam(models.Model):
    ...
    Player1_Points = models.DecimalField(max_digits=5, decimal_places=2, default=Decimal('0.00'))
...
class BENBLRTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(BENBLRTeam, self).save(*args, **kwargs)
...
class TAMHARTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(TAMHARTeam, self).save(*args, **kwargs)
...
class PATPUNTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(PATPUNTeam, self).save(*args, **kwargs)
...
class DELJAITeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(DELJAITeam, self).save(*args, **kwargs)
...
class PATHARTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(PATHARTeam, self).save(*args, **kwargs)
...
class BLRHYDTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(BLRHYDTeam, self).save(*args, **kwargs)
...
class BENMUMTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(BENMUMTeam, self).save(*args, **kwargs)
...
class PATUPTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(PATUPTeam, self).save(*args, **kwargs)
...
class DELPUNTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(DELPUNTeam, self).save(*args, **kwargs)
...
class BLRHARTeam(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.full_team_name = self.username_of_player + "[" + str(self.team_no) + "]" + self.match_slug
        super(BLRHARTeam, self).save(*args, **kwargs)
