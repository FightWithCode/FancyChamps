# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-04-28 09:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=64, unique=True, validators=[django.core.validators.RegexValidator(code='Invalid Username', message='Username only contain A-Z,a-z,0-9 or . _ + - $', regex='^[a-zA-Z0-9.+-_]*$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_send_detail', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_send', models.CharField(max_length=100)),
                ('sent_time', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.CharField(max_length=17, unique=True, validators=[django.core.validators.RegexValidator(message='Please Enter Correct Mobile Number...', regex='^\\d{10}$')])),
                ...
                ('bonus', models.DecimalField(decimal_places=2, default=25, max_digits=4)),
                ('widhdrawable_balance', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
